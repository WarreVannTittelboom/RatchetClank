...
private:
	...
	RigidBodyComponent* pPlayer1Actor{};
	RigidBodyComponent* pPlayer2Actor{};
	RigidBodyComponent* pSphereActor{};
	RigidBodyComponent* pBackGround{};
	RigidBodyComponent* pBoxCollider1{};
	RigidBodyComponent* pBoxCollider2{};
};
